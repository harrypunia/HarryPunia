<template>
  <blockquote class="instagram-media"
    ...
    <div style="padding:16px;">
      <a href="https://www.instagram.com/p/ByMK0YQB0pO/"
      ...
      <p style=" margin:8px 0 0 0; padding:0 4px;"><a href="https://www.instagram.com/p/ByMK0YQB0pO/"
                                                      style=" color:#000; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:normal; line-height:17px; text-decoration:none; word-wrap:break-word;"
                                                      target="_blank">Characters will be added soon ^^ First
        illustration I didn’t need a filter for. Got the palette right. #landscape #illustration #landscapeart</a></p>
      <p style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; line-height:17px; margin-bottom:0; margin-top:8px; overflow:hidden; padding:8px 0 7px; text-align:center; text-overflow:ellipsis; white-space:nowrap;">
        A post shared by <a href="https://www.instagram.com/puniaharsimran/"
                            style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:normal; line-height:17px;"
                            target="_blank"> Harry Punia</a> (@puniaharsimran) on
        <time style=" font-family:Arial,sans-serif; font-size:14px; line-height:17px;"
              datetime="2019-06-02T02:11:22+00:00">Jun 1, 2019 at 7:11pm PDT
        </time>
      </p>
    </div>
  </blockquote>
...
<script>
  export default {
    ...
    data() {
      return {
        link: "https://www.instagram.com/p/" + this.$props.href,
        containerCSS: {
          background: "#FFF",
          border: "0",
          borderRadius: "3px",
          ...
          margin: "1px",
          maxWidth: this.$props.width || "540px",
          padding: "0",
        }
      }
    }
