<template>
  <div class="study-process">
    ...
    <DescriptionImage :src="getImg('d2.jpg')" :title="msg('design.2.title')" :desc="msg('design.2.desc')"/>
    ...
    <DescriptionImage :src="getImg('d7.jpg')" :title="msg('design.7.title')" :desc="msg('design.7.desc')"/>
  </div>
</template>
